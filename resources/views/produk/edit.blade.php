...
@section('content')
    <div class="mx-auto max-w-xl rounded-md border border-zinc-200 bg-white p-6">
        ...
        <form action="{{ route('admin.produk.update', $produk) }}" method="POST" enctype="multipart/form-data" class="mt-6 space-y-4">
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.produk.index') }}" class="text-sm font-medium text-zinc-600 hover:text-zinc-900">Cancel</a>
            </div>
        </form>
    </div>
@endsection
