...
@section('content')
    <section class="rounded-md border border-zinc-200 bg-white p-6 sm:p-8">
        <p class="text-sm font-semibold uppercase text-emerald-700">Tentang</p>
        <h1 class="mt-3 text-3xl font-bold text-zinc-950">Tentang Proyek</h1>
        <p class="mt-4 max-w-3xl text-sm leading-7 text-zinc-600 sm:text-base">Proyek ini adalah aplikasi CRUD produk kerajinan tangan yang dibuat untuk kebutuhan Tugas UAS mata kuliah Rekayasa Web. Aplikasi berfokus pada pengelolaan data produk, tampilan katalog publik, autentikasi admin, unggah gambar, dan ekspor laporan PDF.</p>
    </section>
        ...
        <div class="rounded-md border border-zinc-200 bg-white p-6">
            ...
            <dl class="mt-4 space-y-3 text-sm">
                ...
                <div class="flex justify-between gap-4">
                    <dt class="text-zinc-500">Ekspor</dt>
