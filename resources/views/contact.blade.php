        ...
        <div class="grid gap-0 lg:grid-cols-[0.85fr_1.15fr]">
            <div class="bg-zinc-100 p-5 sm:p-8">
                ...
                <div class="mt-4 rounded-md bg-white p-4">
                    <p class="text-sm font-semibold text-zinc-500">Pemilik Proyek</p>
            ...
            <div class="flex flex-col justify-center p-6 sm:p-8">
                <div class="flex flex-wrap items-center gap-2">
                    <span class="rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold uppercase text-emerald-700">Kontak</span>
                ...
                <dl class="mt-7 grid gap-3 sm:grid-cols-2">
                    ...
                    <div class="rounded-md border border-zinc-200 bg-zinc-50 p-4">
                        <dt class="text-sm text-zinc-500">Peran</dt>
                        <dd class="mt-1 font-semibold text-zinc-950">Pemilik Proyek</dd>
                    </div>
                </dl>

                <div class="mt-7 flex flex-col gap-3 sm:flex-row">
                    <a href="https://zal.pages.dev" target="_blank" rel="noopener noreferrer" class="inline-flex justify-center rounded-md bg-emerald-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-emerald-800">Situs Web</a>
